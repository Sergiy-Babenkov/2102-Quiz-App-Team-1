...
// TODO Change getBookmarkedData to extract question based on id
async function getBookmarkedData(id) {

  fetch('http://127.0.0.1:5000/http://localhost:8182/GET').then(function (response) {
    return response.json();
  }).then(function (data) {
    console.log(data);
    document.getElementById("bookmarked-question-box").innerHTML = data["question"];
    db_answer = data["answer"];
    id = String(data["id"]);
    //alert("id: " + id);
  }).catch(function (e) {
    ...
    <div className="App">
      <header className="App-header">
        <Tabs defaultActiveKey="home">
          ...
          <Tab eventKey="bookmarked" title="Bookmarked Questions">
            <div id="bookmarked-question-box"></div>
            <br />
            <div id="answer-box"></div>
            <input id="answer_box" type="text" value={answer} onChange={handleChange} />

            <Button onClick={() => getBookmarkedData(list_of_bookmarked_ids[curIdx])}>
